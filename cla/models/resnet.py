...
class ResNet(nn.Module): # [3, 4, 6, 3] how many times you use the blocks
    def __init__(self, block, layers, image_channels, no_classes):
        ...
        self.fc = nn.Linear(512 * 4, no_classes)
    ...
    def _make_layer(self, block, num_residual_blocks, out_channels, stride):
        ...
        # layer that changes the nr of channels
